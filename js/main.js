$(document).ready(function () {
  $(window).scroll(function () {
    ...
    if ($(document).scrollTop() > 10) {
      ...
      $(".custom-navbar").css("backgroundColor", "rgba(0, 0, 0, 0.85)");
      $(".activeN").css({
...
`);
  ...
  $(".plus1").on("click", function () {
    if ($(".plus1").text() == "+") {
      $(".brave").append(
        `<div class='additionalText1'><p>We are bold and ambitious. We are not afraid to test new ideas. We are resourceful. We solve hard problems in clever ways.</p></div>`
      );
      $(".plus1").text("-");
      $(".plus2").text("+");
  ...
  $(".plus2").on("click", function () {
    if ($(".plus2").text() == "+") {
      $(".emphatetic")
        .append(`<div class='additionalText2'><p>We don’t pretend to know what all customers want. We listen intently.
  ...
  $(".plus3").on("click", function () {
    if ($(".plus3").text() == "+") {
      $(".accountable")
        .append(`<div class='additionalText3'><p>We got this. We do what we need to do. We don’t let each other
  ...
  $(".plus4").on("click", function () {
    if ($(".plus4").text() == "+") {
      $(".focused")
        .append(`<div class='additionalText4'><p>We have very high standards. We don’t cut corners. We are specialists,
